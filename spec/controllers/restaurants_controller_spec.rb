...
describe RestaurantsController do
  ...
  describe "GET index" do
    ...
    it "should have the right title" do
      get :index
      response.should have_selector("title", :content=> "Restaurants")
    end
  end
  ...
  describe "GET show" do
    ...
    it "should have the right title" do
      get :show, :id => restaurant.id
      response.should have_selector("title", :content=> "Show restaurant")
    end
  end
  ...
  describe "GET new" do
    ...
    it "should have the right title" do
      get :new
      response.should have_selector("title", :content=> "New restaurant")
    end
  end
  ...
  describe "GET edit" do
    ...
    it "should have the right title" do
      get :edit
      response.should have_selector("title", :content=> "Edit restaurant")
    end
  end
